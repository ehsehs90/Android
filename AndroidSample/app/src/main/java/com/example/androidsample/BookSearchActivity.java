...
class SearchTitleRunnable implements Runnable{
    ...
    public void run() {
        ...
        String url="http://70.12.115.58:8080/bookSearch/searchTitle?keyword=" + keyword;
        ...
        try {
            ...
            //얻어온 결과 JSON 문자열을 Jackson library 를 이용해서 Java 객체 형태로 변형
            // Java 객체 형태(String[]) 로 변형
            ObjectMapper mapper = new ObjectMapper();
            //Jackson library 를 이용하여 JSON 문자열을 String[] 형태로 변환
            String[] resultArr = mapper.readValue(sb.toString(),String[].class);
                                                ///            /얘를 읽어서 뒤의 String배열형태로 변형할거야
